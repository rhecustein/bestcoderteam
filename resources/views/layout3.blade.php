@php
    $setting = App\Models\Setting::select('logo','favicon','topbar_phone','topbar_email','opening_time','selected_theme','text_direction','commission_type','currency_position')->first();
...
<body class="home_3">
    ...
    @php
        $setting = App\Models\Setting::select('logo','footer_logo','live_chat','default_avatar')->first();
        $social_icons = App\Models\FooterSocialLink::select('icon','link')->get();
