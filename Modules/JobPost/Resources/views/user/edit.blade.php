                        ...
                        <div class="wsus__dashboard_content">
                            <div class="wsus_dashboard_body">
                                <div class="wsus__review_input">
                                    ...
                                    <hr>
                                    <form action="{{ route('jobpost.update',$job_post->id) }}" method="POST"  enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <fieldset>
                                                    ...
                                                    <input type="text" id="title"  name="title" value="{{ $job_post->title }}">
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-6">
                                                <fieldset>
                                                    <legend>{{__('admin.Slug')}}*</legend>
                                                    <input type="text"  id="slug" type="text" name="slug" value="{{ $job_post->slug }}">
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-6">
                                                <fieldset>
                                            ...
                                            <div class="col-lg-6">
                                                <fieldset>
                                                    ...
                                                    <select name="job_type" id="" class="form-select">
                                                        <option {{ 'Hourly' == $job_post->job_type ? 'selected' : '' }} value="Hourly">{{ __('admin.Hourly') }}</option>
                                                        <option {{ 'Daily' == $job_post->job_type ? 'selected' : '' }} value="Daily">{{ __('admin.Daily') }}</option>
                                                        <option {{ 'Monthly' == $job_post->job_type ? 'selected' : '' }} value="Monthly">{{ __('admin.Monthly') }}</option>
                                                        <option {{ 'Yearly' == $job_post->job_type ? 'selected' : '' }} value="Yearly">{{ __('admin.Yearly') }}</option>
                                                    </select>
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-6">
                                                <fieldset>
                                                    ...
                                                    <input type="text"  name="regular_price" id="regular_price" value="{{ $job_post->regular_price }}">
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <fieldset>
                                                    ...
                                                    <input type="text" name="address" id="address" value="{{ $job_post->address }}">
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <fieldset>
                                                    ...
                                                    <textarea class="summernote"  name="description" id="description">{{ $job_post->description }}</textarea>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="dashboard-cehckbox">
                                                 <label>{{__('admin.Visibility Status')}} *</label>
                                                     <input name="status" type="checkbox" {{ $job_post->status == 'enable' ? 'checked' : '' }}>
                                                </div>
                                            </div>
