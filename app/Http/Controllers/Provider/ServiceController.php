...
class ServiceController extends Controller
{
    ...
    public function edit($id){
        ...
        return view('provider.edit_service', compact('categories','service','package_features','what_you_will_provides','benifits','additional_services'));
    }
    ...
    public function reviewList(){
        ...
        return view('provider.review', compact('reviews'));
    }
    ...
    public function showReview($id){
        ...
        return view('provider.show_review', compact('review'));
    }
}
